...
<table class="table table-hover">
    ...
    <tr>
        ...
        <td>
            <wlb:CDropDownList ID="ddlTimeZone" runat="server" CssClass="textInput" Width="144px" />
        </td>
    </tr>
    <tr>
        <td class="fieldTitle">
