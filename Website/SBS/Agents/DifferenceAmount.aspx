<%@ Page Language="VB" MasterPageFile="Agents.master" AutoEventWireup="false" CodeFile="DifferenceAmount.aspx.vb"
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="Server">
   ...
   <input type="button" class="button" style="margin:0 auto" value="Back To Agent Position Report" onclick="window.location='/SBS/Agents/Management/AgentPositionReport.aspx'" />
    </div>
