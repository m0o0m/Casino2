...
Namespace SBSCallCenterAgents
    Partial Class UpdateQuarterScores
...
#Region "Page's Event"
        Protected Sub Page_Init1(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
            ...
            MenuTabName = "GAME_MANAGER"
            SubMenuActive = "MANUAL_QUATERS"
...
#End Region
        ...
        Private Sub resetField()
            ...
            ViewLock = False
            IsFinalGames = False
            rdGameType.SelectedValue = "GAMES"
        ...
        Private Sub bindGames()
            ...
            If oTbl IsNot Nothing Then
                ...
                oTbl.DefaultView.RowFilter = "GameType in ('NBA Basketball', 'NFL Football')"
