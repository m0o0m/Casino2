  ...
  <script language="javascript">
      ...
      var btnContinue="<%=btnContinue.ClientID %>";
        ...
        <div style="position:relative;top:-30px;text-align:center;font-weight:900;color:white;">
            Wager type :<span id="Span1"> <%=IIf(UserSession.SelectedBetType(Me.SelectedPlayerID) <> "PROP", BetTypeActive.Replace("BetTheBoard", "Straight").Replace("Reverse", "Action Reverse"), "Proposition/Future")%></span>
        </div>
