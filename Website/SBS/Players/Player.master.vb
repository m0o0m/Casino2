...
#End Region
    ...
    End Sub
     ...
     Private Sub InitLayout6()
        _headerTopBarLayout4.Visible = False
        _mainMenuLayout4.Visible = False
        _breadCrumbLayout4.Visible = False
        ltrCopyRight.Visible = False

        _cssLayout6.Visible = True
        _headScriptsLayout6.Visible = True
        _headerTopBarLayout6.Visible = True
        _mainMenuLayout6.Visible = True
        _scriptsLayout6.Visible = True
    End Sub
End Class
