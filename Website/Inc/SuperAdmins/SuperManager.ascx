<%@ Control Language="VB" AutoEventWireup="false" CodeFile="SuperManager.ascx.vb"
    Inherits="SBCSuperAdmin.SuperManager" %>
<%@ Register Assembly="WebsiteLibrary" Namespace="WebsiteLibrary" TagPrefix="wlb" %>
<%@ Register Src="~/Inc/SuperAdmins/SuperEdit.ascx" TagName="SuperEdit" TagPrefix="uc1" %>

<script type="text/javascript" language="javascript">
    function CheckAllSuper(checkAll) {
        var oGrid = document.getElementById('<%=dgSuper.ClientID%>');
...
<div class="row">
    <div class="col-lg-12">
        <asp:Button ID="btnLock" runat="server" Text="Lock" ToolTip="Lock Admins" CssClass="btn btn-default" />
            <asp:Button ID="btnViewLock" runat="server" Text="View Lock" ToolTip="View lock Admins"
...
<div class="row">
    <div class="col-lg-6">
        <asp:DataGrid ID="dgSuper" runat="server" AutoGenerateColumns="false" CssClass="table table-hover table-bordered">
                ...
                <Columns>
                    <asp:TemplateColumn ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20">
                        <HeaderTemplate>
                            <input id="chkChoice" type="checkbox" onclick="CheckAllSuper(this);" title="Select all"
                                runat="server" />
                        </HeaderTemplate>
                        <ItemTemplate>
                    ...
                    <asp:BoundColumn DataField="IsManager" HeaderText="Manager" ItemStyle-Width="50"
    ...
    <div class="col-lg-6" id="tdSuperEdit" runat="server">
        <uc1:SuperEdit ID="ucSuperEdit" runat="server" />
    </div>
</div>
<div class="mbxl"></div>
