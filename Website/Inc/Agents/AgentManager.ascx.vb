...
Namespace SBSAgents
    Partial Class Inc_Agents_AgentManager
...
#Region "Bind Data"
        ...
        Private Function loadAgents() As DataTable
            ...
            Dim dtParents As DataTable = oAgentManager.GetAllAgentsByAgent(UserSession.UserID, Me.ViewBettingLock, Me.ViewLock, txtNameOrLogin.Text)
...
#End Region
        ...
        Protected Sub dgAgents_ItemCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dgAgents.ItemCommand
            Dim sAgentID As String = SafeString(e.CommandArgument)
            Select Case UCase(e.CommandName)
                Case "EDITUSER"
                    If Not ucAgentEdit.LoadAgentInfo(sAgentID.Split("|"c)(0)) Then
