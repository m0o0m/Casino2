    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If Not checkBetting() Then
                Return
            End If
            If (UserSession.SelectedBetType(Me.SelectedPlayerID) <> "PROP") AndAlso (BetTypeActive.Equals(_sBetTheBoard, StringComparison.CurrentCultureIgnoreCase) OrElse BetTypeActive.Equals(_sParlay, StringComparison.CurrentCultureIgnoreCase) OrElse BetTypeActive.Equals(__BetIfAll, StringComparison.CurrentCultureIgnoreCase)) Then
            ...
            If BetTypeActive.Equals(_sBetTheBoard, StringComparison.CurrentCultureIgnoreCase) OrElse BetTypeActive.Equals(_sStraight, StringComparison.CurrentCultureIgnoreCase) Then
                pnCheckSameMount.Visible = False
            End If
...
PropGame:
    ...
    Public Sub ParseBuyPointOptions(ByVal pnJuice As Double, ByVal pnBetPoint As Double, ByVal psBetType As String, ByVal psContext As String, ByVal psGameType As String, ByVal ddlBuyPoint As CDropDownList, ByVal lblOdd As Label, Optional ByVal bTotalOver As Boolean = False)
        Try
            ...
            If chkBuyPoint.Checked AndAlso (BetTypeActive.Equals(_sBetTheBoard, StringComparison.CurrentCultureIgnoreCase) OrElse BetTypeActive.Equals(_sParlay, StringComparison.CurrentCultureIgnoreCase) OrElse BetTypeActive.Equals(__BetIfAll, StringComparison.CurrentCultureIgnoreCase)) Then
