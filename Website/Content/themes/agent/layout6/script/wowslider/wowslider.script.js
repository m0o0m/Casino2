...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"fly",prev:"",next:"",duration:14*100,delay:32*100,width:938,height:285,autoPlay:true,stopOnHover:false,loop:false,bullets:true,caption:false,captionEffect:"slide",controls:false,logo:"engine1/loading.gif",onBeforeStep:0,images:0});