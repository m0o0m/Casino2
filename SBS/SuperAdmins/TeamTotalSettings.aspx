<%@ Page Language="VB" MasterPageFile="~/SBS/SuperAdmins/SuperAdmin.master" AutoEventWireup="false" CodeFile="TeamTotalSettings.aspx.vb" Inherits="SBS_SuperAdmins_TeamTotalSettings" %>
        ...
        <asp:UpdatePanel runat="server" ID="aa">
            <ContentTemplate>
                <asp:Panel ID='pnlGameMonitor' runat="server" CssClass="col-lg-12">
                    <style type="text/css">
                        .bet_input { text-align: right; width: 35px; }
                    </style>
                                        ...
                                        <HeaderTemplate>
                                            <table class="<%# IIF(Container.ItemType = ListItemType.Item,"gametable_odd","gametable_even") %> table table-hover table-bordered">
                                                ...
                                                <tr class="tableheading" style="text-align: center;">
                                                    ...
                                                    <td>Team Total</td>
                                                    <td>Team Total Over</td>
                                                    <td>Team Total Under</td>
                                                    <td></td>
                                                </tr>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <tr <%#IIf(Container.DataItem("isNew").Equals("Y"), "class='isnew'", "")%>>
                                                ...
                                                <td align="center">
                                                    <asp:TextBox Enabled='<%# Not IsManual%>' CssClass="bet_input textInput" ID="txtAwaySpread"
                                                        runat="server" Text='<%#FormatValue(Container.DataItem("AwaySpread"))%>' onkeypress="javascript:return inputNumber(this,event, true);"
                                                        MaxLength="7" />
                                                    -
                                                        <asp:TextBox Enabled='<%# Not IsManual%>' CssClass="bet_input textInput" ID="txtAwaySpreadMoney"
                                                ...
                                                <td align="center">O
                                                        <asp:TextBox Enabled='<%# Not IsManual%>' CssClass="bet_input textInput" ID="txtAwayTotal"
                                                            runat="server" Text='<%#FormatValue(Container.DataItem("TotalPoints"))%>' onkeypress="javascript:return inputNumber(this,event, true);"
                                                            MaxLength="7" />
                                                    -
                                                        <asp:TextBox Enabled='<%# Not IsManual%>' CssClass="bet_input textInput" ID="txtTotalPointsOverMoney"
                                                            runat="server" Text='<%#FormatValue(Container.DataItem("TotalPointsOverMoney"))%>'
                                                            onkeypress="javascript:return inputNumber(this,event, true);" MaxLength="7" />
                                                </td>
                                                <td align="center">
                                                    <asp:TextBox Enabled='<%# Not IsManual%>' CssClass="bet_input textInput" ID="txtAwayMoneyLine"
                                                ...
                                                <td align="center">
                                                    <asp:TextBox Enabled='<%# IsManual%>' CssClass="bet_input textInput" ID="txtAwayTeamTotal"
                                                        runat="server" Text='<%#FormatValue(Container.DataItem("AwayTeamTotalPoints"))%>' onkeypress="javascript:return inputNumber(this,event, true);"
                                                        MaxLength="7" />
                                                </td>
                                                <td align="center">
                                                    <asp:TextBox Enabled='<%# IsManual%>' CssClass="bet_input textInput" ID="txtAwayTeamTotalOver"
                                                        runat="server" Text='<%#FormatValue(Container.DataItem("AwayTeamTotalPointsOverMoney"))%>' onkeypress="javascript:return inputNumber(this,event, true);"
                                                        MaxLength="7" />
                                                </td>
                                                <td align="center">
                                                    <asp:TextBox Enabled='<%# IsManual%>' CssClass="bet_input textInput" ID="txtAwayTeamTotalUnder"
                                                        runat="server" Text='<%#FormatValue(Container.DataItem("AwayTeamTotalPointsUnderMoney"))%>' onkeypress="javascript:return inputNumber(this,event, true);"
                                                        MaxLength="7" />
                                                </td>
                                                <td rowspan="2">
                                                    <asp:Button ID="btnUpdateLine" runat="server" Visible='<%# IsManual %>' Text="Update Line"
                                                        ToolTip="Update Lines" CssClass="button" CommandArgument='<%#Container.DataItem("GameID")%>'
                                                        CommandName='UPDATE_TEAM_TOTAL_LINE' />
                                            ...
                                            <tr <%#IIf(Container.DataItem("isNew").Equals("Y"), "class='isnew'", "")%>>
                                                ...
                                                <td align="center">
                                                    <asp:TextBox Enabled="false" CssClass="bet_input textInput" ID="txtHomeSpread" runat="server"
                                                        ...
                                                        MaxLength="7" />
                                                    -
                                                        <asp:TextBox Enabled='<%# Not IsManual%>' CssClass="bet_input textInput" ID="txtHomeSpreadMoney"
                                                ...
                                                <td align="center">U
                                                        <asp:TextBox CssClass="bet_input textInput" ID="txtTotalPoints2" Enabled="false"
                                                            ...
                                                            MaxLength="7" />
                                                    -
                                                        <asp:TextBox Enabled='<%# Not IsManual%>' CssClass="bet_input textInput" ID="txtTotalPointsUnderMoney"
                                                            runat="server" Text='<%#FormatValue(Container.DataItem("TotalPointsUnderMoney"))%>'
                                                            onkeypress="javascript:return inputNumber(this,event, true);" MaxLength="7" />
                                                </td>
                                                <td align="center">
                                                    <asp:TextBox Enabled='<%# Not IsManual%>' CssClass="bet_input textInput" ID="txtHomeMoney"
                                                        runat="server" Text='<%#FormatValue(Container.DataItem("HomeMoneyLine")) %>'
                                                        onkeypress="javascript:return inputNumber(this,event, true);" MaxLength="7" />
                                                </td>
                                                <td align="center">
                                                    <asp:TextBox Enabled='<%# IsManual%>' CssClass="bet_input textInput" ID="txtHomeTeamTotal"
                                                        runat="server" Text='<%#FormatValue(Container.DataItem("HomeTeamTotalPoints"))%>' onkeypress="javascript:return inputNumber(this,event, true);"
                                                        MaxLength="7" />
                                                </td>
                                                <td align="center">
                                                    <asp:TextBox Enabled='<%# IsManual%>' CssClass="bet_input textInput" ID="txtHomeTeamTotalOver"
                                                        runat="server" Text='<%#FormatValue(Container.DataItem("HomeTeamTotalPointsOverMoney"))%>' onkeypress="javascript:return inputNumber(this,event, true);"
                                                        MaxLength="7" />
                                                </td>
                                                <td align="center">
                                                    <asp:TextBox Enabled='<%# IsManual%>' CssClass="bet_input textInput" ID="txtHomeTeamTotalUnder"
                                                        runat="server" Text='<%#FormatValue(Container.DataItem("HomeTeamTotalPointsUnderMoney"))%>' onkeypress="javascript:return inputNumber(this,event, true);"
                                                        MaxLength="7" />
                                                </td>
                                            </tr>
                                        </ItemTemplate>
