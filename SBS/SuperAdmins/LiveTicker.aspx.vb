...
#End Region
        ...
        Protected Sub Page_Init1(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
            Me.PageTitle = "Live Ticker"
            Me.SideMenuTabName = "LIVE_TICKER"
            Me.MenuTabName = "Liver Ticker"
            DisplaySubTitlle(Me.Master, "Live Ticker")
        End Sub
...
#End Region
        ...
        Private Sub bindTickets()
            ...
            If SelectedSubAgent.Equals(ALL) Then
                ucTicketBetsGrid.LoadTicketBets((New CTicketManager).GetOpenTicketsByAllSubAgent(getListAgentIDBySuperID(UserSession.UserID), EDate, SelectedTypeOfBet, SafeDouble(txtThreshold.Text)), ddlContext.SelectedValue, True)
            ...
            If SelectedPlayer.Equals(ALL) Then
                ...
                ucTicketBetsGrid.LoadTicketBets(oTicketBets, ddlContext.SelectedValue, True)
                ucTicketBetsGrid.ShowPlayerColumn = SelectedPlayer.Equals(ALL)
                Return
            End If

            oTicketBets = (New CTicketManager).GetOpenTicketsByAgent(SelectedSubAgent, EDate, SelectedPlayer, SelectedTypeOfBet, Nothing, SafeDouble(txtThreshold.Text))
            ucTicketBetsGrid.LoadTicketBets(oTicketBets, ddlContext.SelectedValue, True)
            ucTicketBetsGrid.ShowPlayerColumn = SelectedPlayer.Equals(ALL)
        End Sub
