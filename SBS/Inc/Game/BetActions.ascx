...
<asp:Literal ID="ltlTitle" runat="server"></asp:Literal>
                                                    ...
                                                    <tr context='<%# Container.DataItem("Context")%>' class='<%# "GameHeader2 " + If(Container.ItemIndex Mod 2 = 0, "", "success") & If(SBCBL.std.SafeDate(Container.DataItem("GameDate")).DayOfWeek = DayOfWeek.Monday, " mondaygame", "")%>'>
                                                        <th id="tdDate" runat="server">Date
                                                        </th>
                                                        <th id="tdNum" runat="server">#
                                                        </th>
                                                        <th id="tdTeam" align="left" runat="server">Team
                                                        </th>
                                                        ...
                                                        <th align="left" id="tdMLine" runat="server">Money Line
                                                        </th>
                                                    ...
                                                    <tr class='<%# "offering_pair_" + SBCBL.std.SafeString(ViewState("OddEven")) & If(Container.ItemIndex Mod 2 = 0, "", " success") & If(SBCBL.std.SafeDate(Container.DataItem("GameDate")).DayOfWeek = DayOfWeek.Monday, " mondaygame", "")%>' context='<%#Container.DataItem("Context")%>'>
                                                        <td width="100">
...
&nbsp;&nbsp;
                                                        ...
                                                        <td id="tdSpread2" runat="server" width="190">
                                                            <asp:TextBox ID="txtMoneyAwaySpread" runat="server" size="3" MaxLength="5" onkeypress="javascript:return inputNumber(this,event, false);"
                                                                AutoPostBack="false" />
...
<%#IIf(SBCBL.std.IsBaseball(Container.DataItem("GameType")), "<span class='mlaction'>Listed </span>", "")%>
                                                    ...
                                                    <tr class='<%# "offering_pair_" + SBCBL.std.SafeString(ViewState("OddEven")) & If(Container.ItemIndex Mod 2 = 0, "", " success") & If(SBCBL.std.SafeDate(Container.DataItem("GameDate")).DayOfWeek = DayOfWeek.Monday, " mondaygame", "")%>' context='<%#Container.DataItem("Context")%>'>
                                                        ...
                                                        <td id="tdTeam_Total_HomeUnder" runat="server">
                                                            <asp:TextBox ID="txtMoneyHomeTeamTotalUnder" runat="server" size="3" MaxLength="5" onkeypress="javascript:return inputNumber(this,event, false);" AutoPostBack="false" />
                                                    ...
                                                    <tr id="trDraw" runat="server" visible="false" class='<%#getCssClass() & If(Container.ItemIndex Mod 2 = 0, "", " success") & If(SBCBL.std.SafeDate(Container.DataItem("GameDate")).DayOfWeek = DayOfWeek.Monday, " mondaygame", "")%>' context='<%#Container.DataItem("Context")%>'>
                                                        <td></td>
                                                        <td>
