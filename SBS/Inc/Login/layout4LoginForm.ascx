<%@ Control Language="VB" AutoEventWireup="false" CodeFile="layout4LoginForm.ascx.vb" Inherits="SBS_Inc_Login_layout4LoginForm" %>
        ...
        <div class="login-wrap">
            <form runat="server" id="form1">
                ...
                <div class="submit-btn-box">
                    <input type="submit" class="submit-btn" value="Login"></div>--%>
                ...
                <asp:Login ID="Login1" runat="server" DisplayRememberMe="False" TitleText="" PasswordRequiredErrorMessage="Password is required"
                    ...
                    <LayoutTemplate>
                        ...
                        <div class="submit-btn-box">
                            <asp:Button ID="LoginButton" runat="server" CommandName="Login" Text="Login" ValidationGroup="Login1" CssClass="submit-btn" />
                        </div>
