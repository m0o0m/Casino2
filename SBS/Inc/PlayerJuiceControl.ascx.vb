...
#Region "Bind Data"
    ...
    Private Sub bindJuice()
        txtJuice.Text = UserSession.Cache.GetPlayerJuiceControl(ddlPlayer.SelectedValue, ddlSportType.SelectedValue, ddlContext.SelectedValue, ddlGameType.SelectedValue)
    End Sub
...
#End Region
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If oSysManager.CheckExistSysSetting(playerId & "_Juice", ddlSportType.SelectedValue, ddlContext.SelectedValue, ddlGameType.SelectedValue) Then
            LogDebug(_log, "save")
            ...
            oSysManager.UpdateValue(playerId & "_Juice", ddlSportType.SelectedValue, ddlContext.SelectedValue, std.SafeInteger(txtJuice.Text), psOrther:=ddlGameType.SelectedValue)
        Else
            ...
            oSysManager.AddSysSetting(playerId & "_Juice", ddlContext.SelectedValue, std.SafeInteger(txtJuice.Text), ddlSportType.SelectedValue, psOrther:=ddlGameType.SelectedValue)

        End If

        UserSession.Cache.ClearSysSettings(playerId & "_Juice", ddlSportType.SelectedValue)
        UserSession.Cache.ClearPlayerJuiceControl(UCase(playerId), UCase(ddlSportType.SelectedValue), UCase(ddlContext.SelectedValue), ddlGameType.SelectedValue)
        bindJuice()
