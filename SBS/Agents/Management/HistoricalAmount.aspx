<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HistoricalAmount.aspx.vb"
    Inherits="SBCSuperAdmins.HistoricalAmount" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<%@ Register Src="~/Inc/SuperAdmins/YearlyTotalDetail.ascx" TagName="HistoricalAmount"
    TagPrefix="uc" %>
                        ...
                        <ul class="bottomtab" style="margin-bottom: 0px; margin-left: 0px; padding-left: 0px">
                            <li>
                                <asp:LinkButton runat="server" ID="lbtTabWeekly" CommandArgument="WEEKLY" Text="Weekly"
                                    ToolTip="Weekly Statistical Report" CausesValidation="false" OnClick="lbtTab_Click"
                                    PostBackUrl="#" />
                            </li>
                            <li>
                                <asp:LinkButton runat="server" ID="lbtYTD" CommandArgument="YTD" Text="Year To Date"
                                    ToolTip="Year to date Statistical Report" CausesValidation="false" OnClick="lbtTab_Click"
                                    PostBackUrl="#" />
                            </li>
                            <li>
                                <asp:LinkButton runat="server" ID="lbtYearly" CommandArgument="YEARLY" Text="Yearly"
                                    ToolTip="Yearly Statistical Report" CausesValidation="false" OnClick="lbtTab_Click"
                                    PostBackUrl="#" />
                            </li>
                        </ul>
                    </td>
